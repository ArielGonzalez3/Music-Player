...
// API Web audio y como usarla
const audio = new Audio();

// Objeto que almacenara el segimiento de la cancion 
let userData = {
  songs: [...allSongs],
  // Para manejar la información de la canción actual y realizar un seguimiento de su tiempo de reproducción
  currentSong: null,
  songCurrentTime: 0
};
